package com.brandon.running_app.adapter
...
class RunAdapter : RecyclerView.Adapter<RunAdapter.RunViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RunViewHolder {
        val runItemView = LayoutInflater.from(parent.context).inflate(R.layout.item_run, parent, false)
        return RunViewHolder(runItemView)
    }
